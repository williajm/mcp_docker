...
Serwer [Model Context Protocol (MCP)](https://modelcontextprotocol.io), który udostępnia funkcjonalność Dockera asystentom AI, takim jak Claude. Zarządzaj kontenerami, obrazami, sieciami i wolumenami poprzez bezpieczne API z pełną kontrolą typów i systemem zabezpieczeń.
