...
Gweinydd [Protocol Cyd-destun Model (MCP)](https://modelcontextprotocol.io) sy'n datgelu swyddogaeth Docker i gynorthwywyr AI fel Claude. Rheoli cynwysyddion, delweddau, rhwydweithiau, a chyfrolau trwy API math-ddiogel, wedi'i ddogfennu gyda rheolyddion diogelwch.
