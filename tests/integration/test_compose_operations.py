...
# Note: MCP tool integration tests for compose are pending full compose feature merge
# These tests will be added once the compose tools are registered in the server
